...
- Having the module functions isolated helps to treeshake them and use them on demand.
- If you include them within a hook you need to memoize them to not recreate/retrigger side effects, having the dependency list and creating an spider web effect.
- Super useful for async calls.
