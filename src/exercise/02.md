...
- React.cloneElement is great when you want to share state between childrens on compound components without lifting the state or exposing the inner state.
- This is called 'Implicit state' for compound components
