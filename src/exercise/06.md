...
- Check the custom hooks created
  - Warning on readonly
  - Warning on controlled/uncontrolled change (from undefined to a value)
- Dead code elimination will act if process.env.NODE_ENV will get the code away if its not prod
