...
- Create the context.
- Give a display name.
- Create a provider from the context.
- Create a safe hook.
- Use the hook when consuming the value.
- React.cloneElement is useful when you only care about the direct children of the component.
